...
class AlignViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    override func viewDidLoad() {
        ...
        let flowLayout = AlignCellFlowLayout(AlignType.left, interitemSpacing)
        ...
        collectionView.register(AlignCollectionReusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "headerIdentifier")
        collectionView.register(AlignCollectionViewCell.self, forCellWithReuseIdentifier: "CellIdentifier")
    }
    func loadData(){
        for _ in 0 ... 1{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CellIdentifier", for: indexPath) as! AlignCollectionViewCell
