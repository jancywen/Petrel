...
let sectionInset = UIEdgeInsets(top: 0, left: 15, bottom: 15, right: 15)


class AlignCellFlowLayout: UICollectionViewFlowLayout {
    //两个Cell之间的距离
    ...
    override init() {
        betweenOfCell = interitemSpacing
        super.init()
