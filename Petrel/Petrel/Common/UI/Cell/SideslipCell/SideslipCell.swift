...
//  Petrel
//
//  Created by jancywen on 2020/6/2.
 ...
 *  2.使用简单，继承于SideslipCell即可
 *
 *  使用步骤：
 *  1.将你的tableViewCell继承于SideslipCell
...
protocol SideslipCellDelegate:NSObjectProtocol {
...
let SideslipCellNSNotification = "SideslipCellNSNotification"

public enum SideslipCellState : Int {
    case center
    case left
    case right
}

class SideslipCell: UITableViewCell, UIScrollViewDelegate {
    
    var scrollView:UIScrollView?
    var editButtonArray:[UIButton]?
    var confirmButton:UIButton?
    var confirmButtonIndex:Int = 0
    weak var delegate:SideslipCellDelegate?
    
    private var     _cellState:SideslipCellState = .center
    ...
    override func draw(_ rect: CGRect) {
        ...
        if scrollView == nil {
            ...
            NotificationCenter.default.addObserver(self,
                                                   ...
                                                   name: NSNotification.Name(rawValue: SideslipCellNSNotification),
                                                   object: nil)
        }
    ...
    @objc func dealNotification(_ info: Notification) {
        guard  info.object as?SideslipCell == self else {
    ...
    @objc func tapClicked(_ tap:UITapGestureRecognizer) {
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: SideslipCellNSNotification), object: self)
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        NotificationCenter.default.post(name: Notification.Name(rawValue:SideslipCellNSNotification), object: self)
